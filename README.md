...
- [Awesome Semantic Web ](#awesome-semantic-web-)
  - [Contents](#contents)
  - [Standards](#standards)
    - [RDF](#rdf)
    - [RDFS](#rdfs)
    ...
    - [Linked Data Templates](#linked-data-templates)
  ...
  - [Mapping](#mapping)
    ...
    - [RDF to Property Graphs](#rdf-to-property-graphs)
    - [XML](#xml)
      - [R2RML](#r2rml-1)
        - [xR2RML](#xr2rml)
        - [R2RML-F](#r2rml-f)
  ...
  - [Editors](#editors)
    - [VIM](#vim)
    - [Emacs](#emacs)
    - [JetBrains IDEs: Intellij IDEA, PyCharm, etc.](#jetbrains-ides-intellij-idea-pycharm-etc)
...
### Publications Office of the European Union
 - [Ontologies](https://op.europa.eu/en/web/eu-vocabularies/ontologies) - Ontologies published or maintained by Publications Office. 
 - [ShowVoc datasets](https://showvoc.op.europa.eu/#/datasets) - Publications Office instance of ShowVoc to disseminate controlled vocabularies, taxonomies and other RDF datasets.
